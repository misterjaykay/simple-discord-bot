...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const sessionId = await createSession(interaction.guild.id, interaction.user.id, candidate, eligibility.targetSlot, generation);
    return interaction.editReply(buildPreviewMessage(sessionId, await getSession(sessionId)));
  },
};
